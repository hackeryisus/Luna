...
$wp_customize->add_section('certification_section',array(
'title'=>__("Certification Options",'weblizar'),
'panel'=>'enigma_theme_option',
'capability'=>'edit_theme_options',
	'priority' => 35,
'active_callback' => 'is_front_page',
...
$wp_customize->add_setting(
'enigma_options[home_certification_heading]',
	array(
	'default'=>esc_attr($wl_theme_options['home_certification_heading']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_control( 'home_certification_heading', array(
	'label'        => __( 'Home Certification Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[home_certification_heading]'
) );
$wp_customize->add_setting(
'enigma_options[certification_1_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_1_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[certification_2_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_2_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[certification_3_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_3_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[certification_1_title]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_1_title']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
		)
...
$wp_customize->add_setting(
'enigma_options[certification_2_title]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_2_title']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text'
	)
...
$wp_customize->add_setting(
'enigma_options[certification_3_title]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_3_title']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_setting(
'enigma_options[certification_1_text]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_1_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
		)
...
$wp_customize->add_setting(
'enigma_options[certification_2_text]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_2_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_setting(
'enigma_options[certification_3_text]',
	array(
	'default'=>esc_attr($wl_theme_options['certification_3_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_control( 'certification_one_title', array(
	'label'        => __( 'Certification One Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_1_title]'
) );

	$wp_customize->add_control('enigma_options[certification_1_icons]',
			array(
		'label'        => __( 'Certification Icon One', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'certification_section',
		'type'=>'text',
		'settings'   => 'enigma_options[certification_1_icons]'
			)
	);

$wp_customize->add_control( 'certification_one_text', array(
	'label'        => __( 'Certification One Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_1_text]'
) );
	$wp_customize->add_control(
	new enigma_Customize_Misc_Control(
			$wp_customize,
			'certification_options2-line',
			array(
					'section'  => 'certification_section',
					'type'     => 'line'
			)
	));
$wp_customize->add_control( 'certification_two_title', array(
	'label'        => __( 'Certification Two Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_2_title]'
) );
	$wp_customize->add_control( 'enigma_options[certification_2_icons]',
			array(
		'label'        => __( 'Certification Icon Two', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'certification_section',
		'type'=>'text',
		'settings'   => 'enigma_options[certification_2_icons]'
			)
	);
$wp_customize->add_control( 'enigma_certification_two_text', array(
	'label'        => __( 'Certification Two Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_2_text]'
) );
	$wp_customize->add_control(new enigma_Customize_Misc_Control(
			$wp_customize, 'enigma_certification_options3-line',
			array(
					'section'  => 'certification_section',
					'type'     => 'line'
			)
	));
$wp_customize->add_control( 'enigma_certification_three_title', array(
	'label'        => __( 'Certification Three Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_3_title]'
) );
$wp_customize->add_control('enigma_options[certification_3_icons]',
			array(
		'label'        => __( 'Certification Icon Three', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'certification_section',
		'type'=>'text',
		'settings'   => 'enigma_options[certification_3_icons]'
			)
	);
$wp_customize->add_control( 'enigma_certification_three_text', array(
	'label'        => __( 'Certification Three Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'certification_section',
	'settings'   => 'enigma_options[certification_3_text]'
) );

/*Avala Section*/

$wp_customize->add_section('avala_section',array(
'title'=>__("Avala Options",'weblizar'),
'panel'=>'enigma_theme_option',
'capability'=>'edit_theme_options',
	'priority' => 35,
'active_callback' => 'is_front_page',
...
$wp_customize->add_setting(
'enigma_options[home_avala_heading]',
	array(
	'default'=>esc_attr($wl_theme_options['home_avala_heading']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_control( 'home_avala_heading', array(
	'label'        => __( 'Home Avala Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[home_avala_heading]'
) );
$wp_customize->add_setting(
'enigma_options[avala_1_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_1_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[avala_2_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_2_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[avala_3_icons]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_3_icons']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
...
$wp_customize->add_setting(
'enigma_options[avala_1_title]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_1_title']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text',
		)
...
$wp_customize->add_setting(
'enigma_options[avala_2_title]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_2_title']),
	'type'=>'option',
	'capability'=>'edit_theme_options',
	'sanitize_callback'=>'enigma_sanitize_text'
	)
...
$wp_customize->add_setting(
'enigma_options[avala_3_title]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_3_title']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_setting(
'enigma_options[avala_1_text]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_1_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
		)
...
$wp_customize->add_setting(
'enigma_options[avala_2_text]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_2_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_setting(
'enigma_options[avala_3_text]',
	array(
	'default'=>esc_attr($wl_theme_options['avala_3_text']),
	'type'=>'option',
	'sanitize_callback'=>'enigma_sanitize_text',
	'capability'=>'edit_theme_options',
	)
...
$wp_customize->add_control( 'avala_one_title', array(
	'label'        => __( 'Avala One Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_1_title]'
) );

	$wp_customize->add_control('enigma_options[avala_1_icons]',
			array(
		'label'        => __( 'Avala Icon One', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'avala_section',
		'type'=>'text',
		'settings'   => 'enigma_options[avala_1_icons]'
			)
	);

$wp_customize->add_control( 'avala_one_text', array(
	'label'        => __( 'Avala One Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_1_text]'
) );
	$wp_customize->add_control(
	new enigma_Customize_Misc_Control(
			$wp_customize,
...
$wp_customize->add_control( 'avala_two_title', array(
	'label'        => __( 'Avala Two Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_2_title]'
) );
	$wp_customize->add_control( 'enigma_options[avala_2_icons]',
			array(
		'label'        => __( 'Avala Icon Two', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'avala_section',
		'type'=>'text',
		'settings'   => 'enigma_options[avala_2_icons]'
			)
	);
$wp_customize->add_control( 'enigma_avala_two_text', array(
	'label'        => __( 'Avala Two Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_2_text]'
) );
	$wp_customize->add_control(new enigma_Customize_Misc_Control(
			$wp_customize, 'enigma_avala_options3-line',
			array(
					'section'  => 'avala_section',
					'type'     => 'line'
			)
	));
$wp_customize->add_control( 'enigma_avala_three_title', array(
	'label'        => __( 'Avala Three Title', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_3_title]'
) );
$wp_customize->add_control('enigma_options[avala_3_icons]',
			array(
		'label'        => __( 'Avala Icon Three', 'weblizar' ),
		'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','weblizar'),
					'section'  => 'avala_section',
		'type'=>'text',
		'settings'   => 'enigma_options[avala_3_icons]'
			)
	);
$wp_customize->add_control( 'enigma_avala_three_text', array(
	'label'        => __( 'Avala Three Text', 'weblizar' ),
	'type'=>'text',
	'section'    => 'avala_section',
	'settings'   => 'enigma_options[avala_3_text]'
) );
