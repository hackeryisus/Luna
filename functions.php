	...
	function weblizar_default_settings()
{
	...
	$wl_theme_options=array(
			...
			//Certifications
			'home_certification_heading' => __('Certifications', 'weblizar' ),
			'certification_1_title'=>__("Primera",'weblizar' ),
			'certification_1_icons'=>"fa fa-google",
			'certification_1_text'=>__("Esta es la primera certificacion.", 'weblizar' ),
			'certification_1_link'=>"#",

			'certification_2_title'=>__('Segunda', 'weblizar' ),
			'certification_2_icons'=>"fa fa-database",
			'certification_2_text'=>__("Esta es la segunda certificacion.", 'weblizar' ),
			'certification_2_link'=>"#",

			'certification_3_title'=>__("Tercera", 'weblizar' ),
			'certification_3_icons'=>"fa fa-wordpress",
			'certification_3_text'=>__("Esta es la tercera certificacion.", 'weblizar' ),
			'certification_3_link'=>"#",

			//Avala
			'home_avala_heading' => __('Avala', 'weblizar' ),
			'avala_1_title'=>__("Primera",'weblizar' ),
			'avala_1_icons'=>"fa fa-google",
			'avala_1_text'=>__("Este es el primer avalador de la pagina.", 'weblizar' ),
			'avala_1_link'=>"#",

			'avala_2_title'=>__('Segunda', 'weblizar' ),
			'avala_2_icons'=>"fa fa-database",
			'avala_2_text'=>__("Este es el cuarto avalador de la pagina.", 'weblizar' ),
			'avala_2_link'=>"#",

			'avala_3_title'=>__("Tercera", 'weblizar' ),
			'avala_3_icons'=>"fa fa-wordpress",
			'avala_3_text'=>__("Este es el tercer avalador de la pagina.", 'weblizar' ),
			'avala_3_link'=>"#",
